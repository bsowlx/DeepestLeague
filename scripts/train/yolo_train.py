"""YOLO Training Script for Minimap Detection."""
...
def find_dataset(name: str) -> Path:
    # Check writable configs first, then original locations
    candidates = [
...
def train(
    ...
    **overrides,
    ...
    """Train YOLO model on minimap dataset."""
...
def main():
    parser = argparse.ArgumentParser(description="Train YOLO for minimap detection")
    parser.add_argument("--model", required=True, help="Model (e.g., yolo11n.pt)")
