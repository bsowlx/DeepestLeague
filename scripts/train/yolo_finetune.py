"""YOLO Fine-tuning Script for Minimap Detection."""
...
def finetune(
    ...
    **overrides,
    ...
    """Fine-tune YOLO model from pretrained weights."""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune YOLO for minimap detection")
